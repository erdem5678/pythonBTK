...
print(f'adim: {p2.name} yaşim: {p2.calculateAge()}')
...
class Circle:
   ...
   # methods
     def cevre_hesapla(self):
         return 2 * self.pi * self.yaricap # Dairenin çevresini hesapla (2 * π * r)
    
     def alan_hesapla(self):
         return self.pi * (self.yaricap**2) # Dairenin alanını hesapla (π * r²)


c1 = Circle() # yaricap = 1
c2 = Circle(int(input('yaricapi giriniz: ')))
